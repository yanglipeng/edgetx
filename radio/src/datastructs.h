...
static inline void check_struct()
{
  ...
  CHKSIZE(FlightModeData, 2 * MAX_TRIMS + LEN_FLIGHT_MODE_NAME + 2 * MAX_GVARS + 4);
...
#elif defined(PCBX7) || defined(PCBXLITE) || defined(PCBXLITES) || defined(PCBX9LITE) || defined(PCBX9LITES) || defined(RADIO_T14) || defined(RADIO_T12MAX) || defined(RADIO_T20V2)
  ...
  // CHKSIZE()
#elif defined(PCBHORUS) || defined(COLORLCD)
