...
LROT_BEGIN(etxcst, NULL, 0)
  ...
  // DSEG7 7-segment digital fonts for instrument panel (indices 8-13)
  LROT_NUMENTRY( DSEG7_32, FONT(DSEG7_32) )
  LROT_NUMENTRY( DSEG7_48, FONT(DSEG7_48) )
  LROT_NUMENTRY( DSEG7_64, FONT(DSEG7_64) )
  LROT_NUMENTRY( DSEG7_BOLD_32, FONT(DSEG7_BOLD_32) )
  LROT_NUMENTRY( DSEG7_BOLD_48, FONT(DSEG7_BOLD_48) )
  LROT_NUMENTRY( DSEG7_BOLD_64, FONT(DSEG7_BOLD_64) )
